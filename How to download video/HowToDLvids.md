...
## Using Windows
### Download [youtube-dl](http://rg3.github.io/youtube-dl/)
...
Go to the [youtube-dl download page](http://rg3.github.io/youtube-dl/download.html) and follow instructions to download the Windows version ("Windows.exe").

<p align="center">
 <img src="https://gist.githubusercontent.com/mhpob/c3b4a6711ea803df9649/raw/a6f272e81580b0785053e9951b1e4e2b563da4a8/youtube-dl.png" alt="youtube-dl download website" width="50%">
</p>
...
This method also works with videos on Facebook, Vimeo, ESPN, NBCSports... [the list goes on](https://github.com/rg3/youtube-dl/blob/master/docs/supportedsites.md).
